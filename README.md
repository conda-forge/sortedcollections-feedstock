About sortedcollections-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sortedcollections-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5094&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sortedcollections-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sortedcollections` can be installed with `conda`:
...
```
mamba install sortedcollections
```

It is possible to list all of the versions of `sortedcollections` available on your platform with `conda`:
...
```
mamba search sortedcollections --channel conda-forge
```
...
mamba repoquery search sortedcollections --channel conda-forge

# List packages depending on `sortedcollections`:
mamba repoquery whoneeds sortedcollections --channel conda-forge

# List dependencies of `sortedcollections`:
mamba repoquery depends sortedcollections --channel conda-forge
```
